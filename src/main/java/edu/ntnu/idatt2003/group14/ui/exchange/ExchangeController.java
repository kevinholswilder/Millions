 ...
 * @since 0.0.1
 */
public class ExchangeController implements PlottableChangeListener {
  ...
  public HBox createStockRow(Stock stock, int index) {
    ...
    Label symbolLabel = (Label) stockBox.getChildren().getFirst();

    Label changeLabel = (Label) changeBox.getChildren().getLast();
